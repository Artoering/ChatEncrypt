...
public class encrypt {
    ...
    private static int ch[]=new int[21];
    ...
    public static int final_key[]=new int[48];
    ...
    static boolean custom_spit_option;
    ...
    public void DoDecryption(String inp_encrypt) {
...
//        System.out.println("PlainTETX: "+ PlainText.substring(start,start+9));
        ...
        System.out.println("");
        //JOptionPane.showMessageDialog(null, newBlock64);    
        System.out.println("Finaly :"+ finalEncry);  
    }
