 ...
 * @author WhoAmI
 */
public class background_backup extends javax.swing.JFrame {

    /**
     * Creates new form background
     */
    public background_backup() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(background_backup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new background_backup().setVisible(true);
            }
        });
    }
